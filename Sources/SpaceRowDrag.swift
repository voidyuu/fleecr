...
final class SidebarRowDragNSView: NSView, NSDraggingSource {
    static let spacePasteboardType = NSPasteboard.PasteboardType("cc.cassiel.fleecr.space-id")
    static let agentPasteboardType = NSPasteboard.PasteboardType("cc.cassiel.fleecr.agent-id")
