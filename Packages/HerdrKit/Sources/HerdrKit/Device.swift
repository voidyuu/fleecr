...
public struct Device: Codable, Sendable, Identifiable, Equatable, Hashable {
    public enum Kind: Codable, Sendable, Equatable, Hashable {
        case local
        case ssh(target: String)   // e.g. "user@10.10.10.87" or "user@remote-mac.tail"
    }
...
public final class DeviceStore: @unchecked Sendable {
    public static let didChangeNotification = Notification.Name("cc.cassiel.fleecr.DeviceStoreDidChange")
