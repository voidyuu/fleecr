...
final class LocalServerTests: XCTestCase {
    ...
    func testServerEnvironmentDropsTheAppsProcessIdentity() {
        let base = [
            "__CFBundleIdentifier": "cc.cassiel.fleecr",
            "XPC_SERVICE_NAME": "application.cc.cassiel.fleecr.1.2",
            "XPC_FLAGS": "0x0",
            "OSLogRateLimit": "1",
            "MallocNanoZone": "0",
    ...
    func testOnlyADeadServerTriggersAnAutoStart() {
        ...
        XCTAssertFalse(HerdrService.isServerDown(
            .remoteHerdrDown(target: "user@10.10.10.87", socketPath: "/home/user/.config/herdr/herdr.sock")
        ))
    }
